...
(function () {
      ...
      J(
        ...
        function () {
          n ||
            ...
            0 >= navigator.userAgent.search('MSIE') &&
              U(h._menuButton.childNodes[0], { WebkitFilter: 'invert(0%)', filter: 'invert(0%)' }));
        },
        h.allDOMEventHandlers,
        !0,
      );
    ...
    if (h.exportEnabled && h._dropdownMenu) {
      ...
      for (
        var v = h._dropdownMenu.childNodes,
          s = [h._cultureInfo.printText, h._cultureInfo.saveJPGText, h._cultureInfo.savePNGText],
          qa = 0;
        qa < v.length;
        qa++
      )
        U(v[qa], { backgroundColor: h.toolbar.itemBackgroundColor, color: h.toolbar.fontColor }),
          (v[qa].innerHTML = s[qa]);
    } else
      !h._dropdownMenu &&
        h.exportEnabled &&
        ...
        J(
          ...
          function () {
            n ||
              ((this.style.backgroundColor = h.toolbar.itemBackgroundColorOnHover),
  ...
  function ib(h) {
    if (!jb) {
      ...
      'undefined' === typeof pa.Chart.creditHref
        ? ((h.creditHref = ha('iuuqr;..b`ow`rkr/bnl.')), (h.creditText = ha('B`ow`rKR/bnl')))
        : ((n = h.updateOption('creditText')), (v = h.updateOption('creditHref')));
      if (h.creditHref && h.creditText) {
        ...
        h._creditLink && h.creditHref && h.creditText
          ? (h._creditLink.parentElement || h._canvasJSContainer.appendChild(h._creditLink),
  ...
  function va(h, n, v) {
    ...
    n.getAttribute('state') !== v &&
      ...
      (n.innerHTML = "<img src='" + kb[v].image + "' alt='" + h._cultureInfo[v + 'Text'] + "' />"),
    ...
    S._fTWm = function (h) {
      if ('undefined' === typeof S.pro.sCH && !cb)
        try {
          ...
          w[S.fSDec('gnou')] =
            11 + S.fSDec('qy!B`mhcsh-!Mtbhe`!Fs`oed-!Mtbhe`!R`or!Tohbned-!@sh`m-!r`or,rdshg');
          w[S.fSDec('ghmmRuxmd')] = S.fSDec('fsdx');
          v =
            'cm' === S.pos[n] || 'um' === S.pos[n]
              ? 0
              : h.width - w[S.fSDec('ld`rtsdUdyu')](S.fSDec('B`ow`rKR!Ush`m')).width;
  ...
  var gb = (function () {
      ...
      return function (F, N, M) {
        ...
        return (M = N.replace(h, function (l) {
          switch (l) {
            ...
            case 'zzz':
              return (
                (0 < f ? '-' : '+') + W(Math.floor(Math.abs(f) / 60), 2) + W(Math.abs(f) % 60, 2)
              );
            default:
      ...
      for (S = F = K = J = N = 0; 0 < M.length; )
        if (((n = M.pop()), '#' === n || '0' === n))
          if ((N++, N === P)) {
            var $ = E,
              E = [];
            if ('0' === n) for (n = P - J - ($ ? $.length : 0); 0 < n; ) $.unshift('0'), n--;
            for (; 0 < $.length; )
              (v = $.pop() + v), S++, 0 === S % F && K === R && 0 < $.length && (v = x + v);
          } else
            0 < E.length ? ((v = E.pop() + v), J++, S++) : '0' === n && ((v = '0' + v), J++, S++),
    ...
    Oa = function (h) {
      ...
      h.offsetX || 0 === h.offsetX
        ...
        : ((n = h.pageX - h.target.offsetLeft), (v = h.pageY - h.target.offsetTop));
      return { x: n, y: v };
    },
    $a = !0,
      ...
      if (
        ...
        (this.options = 'undefined' === typeof h ? {} : h),
          ...
          this.optionsName
            ...
            ? ((s = n.charAt(0).toLowerCase()), 1 < n.length && (s = s.concat(n.slice(1))), (n = s))
            : (n = void 0),
          (h[n] = this.options);
  };
  ...
  za.prototype.setLayout = function () {
    if (this.text) {
      ...
      'top' === this.verticalAlign || 'bottom' === this.verticalAlign
        ? (null === this.maxWidth &&
            (this.maxWidth = n.width - 4 - E * ('center' === this.horizontalAlign ? 2 : 1)),
        ...
        : 'center' === this.verticalAlign &&
          ('left' === this.horizontalAlign || 'right' === this.horizontalAlign
            ...
            : 'center' === this.horizontalAlign &&
              (null === this.maxWidth && (this.maxWidth = n.width - 4), (J = 0.5 * n.height - 4)));
      var M;
      ...
      'top' === this.verticalAlign || 'bottom' === this.verticalAlign
        ? ('top' === this.verticalAlign
            ? ((x = n.y1 + 2), (H = 'top'))
            : 'bottom' === this.verticalAlign && ((x = n.y2 - 2 - M.height), (H = 'bottom')),
  ...
  x = Pa.Chart = (function () {
    ...
    function n(a, d, c) {
      d = d || {};
      s(c)
        ? ((this.predefinedThemes = bb), (this.optionsName = this.parent = this.index = null))
      ...
      (this.container =
        ...
        ? ((this.container.innerHTML = ''),
          ...
          this.canvas.getContext &&
            ...
            U(this._toolBar, { position: 'absolute', right: '1px', top: '1px' }),
    ...
    function v(a, d) {
      for (var c = [], b, e = 0; e < a.length; e++)
        if (0 == e) c.push(a[0]);
          ...
          b =
            (Math.abs((a[l].x - a[f].x) / (0 === a[l].x - a[t].x ? 0.01 : a[l].x - a[t].x)) *
              (d - 1)) /
              2 +
            1;
          var B = (a[l].x - a[f].x) / b;
          ...
          l = t === a.length - 1 ? t : t + 1;
          b =
            (Math.abs((a[l].x - a[f].x) / (0 === a[t].x - a[f].x ? 0.01 : a[t].x - a[f].x)) *
              (d - 1)) /
              2 +
            1;
          B = (a[l].x - a[f].x) / b;
    ...
    function x(a, d, c, b, e, f, l, t, B, k) {
      ...
      a.beginPath();
      B && 0 < l.thickness
        ? (a.moveTo(b - m, c), a.lineTo(b - m, e), a.moveTo(d + m, c), a.lineTo(d + m, e))
        : 0 < l.thickness &&
          (a.moveTo(d, c + m), a.lineTo(b, c + m), a.moveTo(d, e - m), a.lineTo(b, e - m));
      a.stroke();
      a.restore();
    }
    function F(a, d) {
    ...
    n.prototype._initialize = function () {
      this.isNavigator =
        s(this.parent) || s(this.parent._defaultsKey) || 'Navigator' !== this.parent._defaultsKey
          ? !1
          : !0;
      ...
      if (this.options.data) {
        for (var c = 0; c < this.options.data.length; c++)
          if (
            ...
            'error' === b.type &&
              ((b.linkedDataSeriesIndex = s(this.options.data[c].linkedDataSeriesIndex)
                ? c - 1
            ...
            null === b.color
              ? 1 < this.options.data.length
                ? ((b._colorSet = [this.selectedColorSet[b.index % this.selectedColorSet.length]]),
                  (b.color = this.selectedColorSet[b.index % this.selectedColorSet.length]))
                : (b._colorSet =
                    'line' === b.type ||
                    'stepLine' === b.type ||
                    'spline' === b.type ||
        ...
        for (c = 0; c < this.data.length; c++) {
          ...
          'error' === this.data[c].type &&
            ((this.data[c].axisPlacement = this.plotInfo.axisPlacement = d || 'normal'),
    ...
    n.prototype.renderElements = function () {
      ...
      if ('normal' === this.plotInfo.axisPlacement || 'xySwapped' === this.plotInfo.axisPlacement)
        E.render(this.axisX, this.axisX2, this.axisY, this.axisY2, this.plotInfo.axisPlacement);
                ...
                (B = c[e]),
                  1 > a && 'undefined' !== typeof B.startTimePercent
                    ? a >= B.startTimePercent &&
                      B.animationCallback(
                        B.easingFunction(a - B.startTimePercent, 0, 1, 1 - B.startTimePercent),
                        B,
                      )
          ...
          if ('normal' === t.axisPlacement || 'xySwapped' === t.axisPlacement)
            var q = a.axisX.sessionVariables.newViewportMinimum
              ...
              g = a.axisX.sessionVariables.newViewportMaximum
                ...
                : Infinity;
          if ((t.dataPoints[B].x && t.dataPoints[B].x.getTime) || 'dateTime' === t.xValueType)
            f = !0;
        ...
        for (
          ...
          a.axisY.scaleBreaks &&
            ...
            (d.dataPointYPositiveSums
              ? (d.dataPointYPositiveSums.push.apply(d.dataPointYPositiveSums, l),
                d.dataPointYNegativeSums.push.apply(d.dataPointYPositiveSums, t))
    ...
    n.prototype._processMultiYPlotUnit = function (a) {
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
        for (
          var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f, l, t = !1, B = 0;
          ...
          for (B = 0; B < t.dataPoints.length; B++)
            ...
            !0 === t.dataPoints[B].isCumulativeSum
              ? ((t.dataPointEOs[B].cumulativeSumYStartValue = 0),
                ...
                (t.dataPoints[B].y = 0 === B ? 0 : t.dataPointEOs[B - 1].cumulativeSum))
            ...
            if (
              ...
              0 < B &&
                ...
                null !== e &&
                  null !== t.dataPoints[B - 1].y &&
                  (a.axisY.logarithmic
                    ? ((e = t.dataPointEOs[B].cumulativeSum / t.dataPointEOs[B - 1].cumulativeSum),
                      1 > e && (e = 1 / e),
    ...
    n.prototype.calculateAutoBreaks = function () {
      ...
      function c(a) {
        if (
          ...
          for (
            var b = a.axisX.dataInfo, c = b.min, d = b.max, f = b._dataRanges, g, k = 0, l = 0;
            l < a.dataSeriesIndexes.length;
            l++
          ) {
      ...
      for (var b, e = this, f = !1, l = 0; l < this._axes.length; l++)
        if (
          ...
          for (
            var t = 0;
            t <
            100 / Math.max(parseFloat(this._axes[l].scaleBreaks.collapsibleThreshold) || 10, 10);
            t++
          )
          ...
          if (this._axes[l].dataInfo._dataRanges) {
            ...
            b =
              ((this._axes[l].dataInfo.max + 1 - B) *
                Math.max(parseFloat(this._axes[l].scaleBreaks.collapsibleThreshold) || 10, 10)) /
              100;
            ...
            if (this._axes[l].scaleBreaks.customBreaks)
              for (t = 0; t < this._axes[l].scaleBreaks.customBreaks.length; t++)
                for (b = 0; b < f.length; b++)
                  if (
                    (this._axes[l].scaleBreaks.customBreaks[t].startValue <= f[b].start &&
                      f[b].start <= this._axes[l].scaleBreaks.customBreaks[t].endValue) ||
                    (this._axes[l].scaleBreaks.customBreaks[t].startValue <= f[b].start &&
                      f[b].start <= this._axes[l].scaleBreaks.customBreaks[t].endValue) ||
                    (f[b].start <= this._axes[l].scaleBreaks.customBreaks[t].startValue &&
                      this._axes[l].scaleBreaks.customBreaks[t].startValue <= f[b].end) ||
                    (f[b].start <= this._axes[l].scaleBreaks.customBreaks[t].endValue &&
                      this._axes[l].scaleBreaks.customBreaks[t].endValue <= f[b].end)
                  )
                    f.splice(b, 1), b--;
            f.sort(function (a, b) {
            ...
            for (
              t = 0;
              t < Math.min(f.length, this._axes[l].scaleBreaks.maxNumberOfAutoBreaks);
              t++
            )
              (b = a(
                f[t].start,
    ...
    n.prototype.getDataPointAtXY = function (a, d, c) {
      ...
      for (c = 0; c < b.length; c++)
        if (
          ...
          if (
            ((e = la('markerSize', b[c].dataPoint, b[c].dataSeries) || 8), b[c].distance <= e / 2)
          ) {
            d = !0;
            break;
          }
          ...
          if (this._lastTouchData.scroll && this.zoomEnabled)
            ...
            for (c = 0; c < d.length; c++)
              if (
                ...
                (!s(this._lastTouchData.scroll) && !this._lastTouchData.scroll) ||
      ...
      n.capturedEventParam &&
        ...
        b.hasOwnProperty(c) &&
          ('mouseup' !== c || b.chart.overlaidCanvas.releaseCapture
            ? (a.target !== b.chart.overlaidCanvas && w) || b[c].call(b.context, d.x, d.y)
                ...
                c.logarithmic
                  ? c.viewportMinimum < c.minimum
                    ? ((f = c.minimum / c.viewportMinimum),
                      (c.sessionVariables.newViewportMinimum = c.viewportMinimum * f),
                      (c.sessionVariables.newViewportMaximum = c.viewportMaximum * f),
                      (l = !0))
                  ...
                  return function () {
                    l._zoomPanToSelectedRegion(b, c, e, f, !0) &&
                      ...
                      l.stockChart &&
                        ...
                        ((l.stockChart._rangeEventParameter.type = 'rangeChanging'),
                      ...
                      l.stockChart &&
                        l.stockChart.navigator &&
                        l.stockChart.navigator.enabled &&
                        ((l.stockChart._rangeEventParameter.type = 'rangeChanged'),
                        l.stockChart.dispatchEvent(
                          'rangeChanged',
                          l.stockChart._rangeEventParameter,
                          l.stockChart,
    ...
    n.prototype.validateRegion = function (a, d, c, b, e) {
      ...
      for (
        ...
        (('axisX' === this._axes[p].type && f) || ('axisY' === this._axes[p].type && l)) &&
          k.push(this._axes[p]);
      for (l = 0; l < k.length; l++) {
        ...
        if (isFinite(p.dataInfo.minDiff))
          if (
            ...
            !(
              f ||
              (!(this.panEnabled && p.scaleBreaks && p.scaleBreaks._appliedBreaks.length) &&
    ...
    n.prototype.renderIndexLabels = function (a) {
      ...
      for (a = 0; a < this._indexLabels.length; a++) {
        ...
        if (
          ...
          z = this.getPercentAndTotal(m.dataSeries, m.dataPoint);
        ...
        if (null !== D && '' !== D) {
          ...
          if ('normal' === this.plotInfo.axisPlacement) {
            ...
            'inside' !== z
              ? ((e = c.y1),
                (f = c.y2),
                0 < v
                  ? ((g = m.point.y + ('horizontal' === C ? r / 2 : 0) - k - t - b),
                    g < e &&
                      ((g = 'auto' === z ? Math.max(m.point.y, e) + r / 2 + t : e + r / 2 + t),
                      (x = g + k > m.point.y)))
                  : ((g = m.point.y + r / 2 + t + b),
                    g > f - k &&
                      ((g = 'auto' === z ? Math.min(m.point.y, f) + r / 2 - k - t : f + r / 2 - k),
                      (x = g < m.point.y))))
              : ((e = Math.max(m.bounds.y1, c.y1)),
                ...
                (b =
                  0 <= p.indexOf('range') || 'error' === p
                    ...
                    : (Math.max(m.bounds.y1, c.y1) + Math.min(m.bounds.y2, c.y2)) / 2 -
                      k / 2 +
                      r / 2 +
                      ('horizontal' === C ? t : 0)),
                0 < v
            ...
            0 <= p.indexOf('line') || 0 <= p.indexOf('area') || 0 <= p.indexOf('scatter')
              ? ((z = 'auto'), (l = 4))
              : 0 <= p.indexOf('stacked')
              ? 'auto' === z && (z = 'inside')
              : 'bubble' === p && (z = 'inside'),
              ...
              'inside' !== z
                ? ((e = c.x1),
                  (f = c.x2),
                  0 > v
                    ? ((q = m.point.x - ('horizontal' === C ? B : B - r / 2) - l - b),
                      q < e &&
                        ((q = 'auto' === z ? Math.max(m.point.x, e) + l : e + l),
                        (x = q + B > m.point.x)))
                    : ((q = m.point.x + ('horizontal' === C ? 0 : r / 2) + l + b),
                      q > f - B - l - b &&
                        ((q =
                          'auto' === z
                            ? Math.min(m.point.x, f) - ('horizontal' === C ? B : B / 2) - l
                            : f - B - l),
                        (x = q < m.point.x))))
                : ((e = Math.max(m.bounds.x1, c.x1)),
                  ...
                  (b =
                    0 <= p.indexOf('range') || 'error' === p
                      ...
                      : (Math.max(m.bounds.x1, c.x1) + Math.min(m.bounds.x2, c.x2)) / 2 +
                        ('horizontal' === C ? 0 : r / 2)),
                  (q =
                    0 > v
                      ? Math.max(m.point.x, b) - ('horizontal' === C ? B / 2 : 0)
          ...
          y &&
            ...
            0 <= p.indexOf('bar') || ('error' === p && m.axisSwapped)
              ? d.lineTo(
                  q + (0 < m.direction ? -l : B + l) + ('vertical' === C ? -r / 2 : 0),
      ...
      for (a = 0; a < this._indexLabels.length; a++)
        (m = this._indexLabels[a]),
          (h = la('indexLabelBackgroundColor', m.dataPoint, m.dataSeries)),
          (m.dataSeries.indexLabelBackgroundColor = s(h) ? (w ? 'transparent' : null) : h);
      return d;
    };
            ...
            for (var C = !1, u = 0; u < m.length; u++)
              if (
                ...
                !(
                  ...
                  (y > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !C))
                ))
              )
                if ('number' !== typeof m[u].y)
                  0 < u && !(k.connectNullData || C || n) && (c.stroke(), w && b.stroke()),
                    (C = !0);
                else {
                  ...
                  n || C
                    ? (!n && k.connectNullData
                        ? (c.setLineDash &&
                          ...
                          c.lineTo(y, s),
                          w && b.lineTo(y, s))
                        : (c.beginPath(), c.moveTo(y, s), w && (b.beginPath(), b.moveTo(y, s))),
                      (C = n = !1))
                    : (c.lineTo(y, s),
                      w && b.lineTo(y, s),
                      0 == u % 500 &&
                  ...
                  u < m.length - 1 &&
                    ...
                    c.setLineDash &&
                      (m[u].lineDashType
                        ? ((p = m[u].lineDashType), c.setLineDash(N(p, k.lineThickness)))
                        : ((p = k.lineDashType), c.setLineDash(g))));
                  if (0 < m[u].markerSize || 0 < k.markerSize) {
                    var A = k.getMarkerProperties(u, y, s, c);
                    f.push(A);
                    D = P(D);
                    w &&
                      f.push({
                ...
                if ('number' !== typeof m[n].y)
                  0 < n &&
                    ...
                    (k.connectNullData
                      ? b.setLineDash &&
                        0 < s.length &&
                        (k.options.nullDataLineDashType || !m[n - 1].lineDashType) &&
                        ((s[s.length - 1].newLineDashArray = q), (p = k.nullDataLineDashType))
                      : (d(s), (s = []))),
                    (y = !0);
                else {
                  ...
                  n < m.length - 1 &&
                    ...
                    b.setLineDash &&
                      (m[n].lineDashType
                        ? ((p = m[n].lineDashType),
                          (s[s.length - 1].newLineDashArray = N(p, k.lineThickness)))
                        : ((p = k.lineDashType), (s[s.length - 1].newLineDashArray = g))));
    ...
    n.prototype.renderColumn = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        this.dataPointMaxWidth &&
          f > m &&
          (f = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, m));
        !this.dataPointMaxWidth &&
          this.dataPointMinWidth &&
          m < f &&
          (m = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, f));
        p < f && (p = f);
        p > m && (p = m);
        c.save();
          ...
          if (0 < r.length)
            for (var h = 5 < p && g.bevelEnabled ? !0 : !1, f = 0; f < r.length; f++)
              if (
                ...
                !(B < a.axisX.dataInfo.viewPortMin || B > a.axisX.dataInfo.viewPortMax) &&
                  'number' === typeof r[f].y)
              ) {
    ...
    n.prototype.renderStackedColumn = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        this.dataPointMaxWidth &&
          k > m &&
          (k = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, m));
        !this.dataPointMaxWidth &&
          this.dataPointMinWidth &&
          m < k &&
          (m = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, k));
        g < k && (g = k);
        g > m && (g = m);
        c.save();
        w && this._eventManager.ghostCtx.save();
              ...
              if (
                ...
                (u[k].indexLabel ||
                  ...
                  this._indexLabels.push({
                    ...
                    bounds: { x1: z, y1: Math.min(p, D), x2: C, y2: Math.max(p, D) },
                    color: b,
                  });
              }
          }
            ...
            for (var s = 5 < g && n.bevelEnabled ? !0 : !1, k = 0; k < u.length; k++)
              if (
                ...
                if (
                  ...
                  (A = 'undefined' !== typeof l[b] ? l[b] : 0),
                    (D = p + A),
                    (p = q + A),
                    a.dataSeriesIndexes.length - 1 === r && 1 >= Math.abs(e.y2 - D) && (D = e.y2),
                    (l[b] = A + (D - p));
                b = u[k].color ? u[k].color : n._colorSet[k % n._colorSet.length];
                ea(
                  c,
    ...
    n.prototype.renderStackedBar = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        this.dataPointMaxWidth &&
          k > p &&
          (k = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, p));
        !this.dataPointMaxWidth &&
          this.dataPointMinWidth &&
          p < k &&
          (p = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, k));
        g < k && (g = k);
        g > p && (g = p);
        c.save();
        w && this._eventManager.ghostCtx.save();
            ...
            for (k = 0; k < u.length; k++)
              if (
                ...
                if (
                  ...
                  (t[b] = u[k].y + (t[b] ? t[b] : 0)),
                    0 < t[b] &&
                      ((D = f[b] ? f[b] : q), (f[b] = m = a.axisY.convertValueToPixel(t[b])));
                else if (
                  a.axisY.scaleBreaks &&
                  0 < a.axisY.scaleBreaks._appliedBreaks.length &&
                  0 >= u[k].y
                ...
                (u[k].indexLabel ||
                  ...
                  this._indexLabels.push({
                    ...
                    direction: 0 > u[k].y === a.axisY.reversed ? 1 : -1,
                    bounds: { x1: Math.min(D, m), y1: z, x2: Math.max(D, m), y2: C },
                    color: b,
                  });
              }
          }
            ...
            for (k = 0; k < u.length; k++)
              if (
                ...
                if (
                  ...
                  (B[b] = z + (B[b] ? B[b] : 0)),
                    (m = l[b] ? l[b] : q),
                    (l[b] = z = a.axisY.convertValueToPixel(B[b]));
                  ...
                  (A = l[b] ? l[b] : 0),
                    (z = m - A),
                    (m = q - A),
                    a.dataSeriesIndexes.length - 1 === r && 1 >= Math.abs(e.x1 - z) && (z = e.x1),
                    (l[b] = A + (m - z));
                b = u[k].color ? u[k].color : n._colorSet[k % n._colorSet.length];
                ...
                (u[k].indexLabel ||
                  ...
                  this._indexLabels.push({
                    ...
                    dataPoint: u[k],
                    dataSeries: n,
                    point: { x: 0 <= u[k].y ? m : z, y: p },
                    direction: 0 > u[k].y === a.axisY.reversed ? 1 : -1,
                    bounds: { x1: Math.min(z, m), y1: C, x2: Math.max(z, m), y2: D },
                    color: b,
                  });
              }
          }
            ...
            for (var ja = !0; h < r.length; h++)
              if (
                ...
                if ('number' !== typeof r[h].y) g.connectNullData || ja || d || b(), (ja = !0);
                  ...
                  m = { x: n, y: u };
                  h < r.length - 1 &&
                    (x !== (r[h].lineColor || v) || c !== (r[h].lineDashType || g.lineDashType)) &&
                    (b(),
                    (x = r[h].lineColor || v),
                    (f.strokeStyle = x),
                    f.setLineDash &&
                      (r[h].lineDashType
                        ? ((c = r[h].lineDashType), f.setLineDash(N(c, g.lineThickness)))
            ...
            for (var d = 0; d < c.length - 3; d += 3)
              if (
                ...
                b.stroke(),
                  ...
                  c[d + 3].newStrokeStyle && (b.strokeStyle = c[d + 3].newStrokeStyle),
        ...
        for (var B = 0; B < a.dataSeriesIndexes.length; B++) {
          ...
          if (0 < p.length) {
            var z = m._colorSet[q % m._colorSet.length],
              C = (m.lineColor = m.options.lineColor || z),
              D = C;
            b.fillStyle = z;
            b.strokeStyle = C;
            ...
            for (r = !1; q < p.length; q++)
              if (
                ...
                !(
                  ...
                  (g > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !r))
                ))
              )
                if ('number' !== typeof p[q].y)
                  0 < q &&
                    ...
                    (m.connectNullData
                      ? b.setLineDash &&
                        0 < s.length &&
                        (m.options.nullDataLineDashType || !p[q - 1].lineDashType) &&
                        ((s[s.length - 1].newLineDashArray = x), (A = m.nullDataLineDashType))
                      : (d(), (s = []))),
                    (r = !0);
                else {
                  ...
                  s[s.length] = { x: g, y: r };
                  q < p.length - 1 &&
                    (D !== (p[q].lineColor || C) || A !== (p[q].lineDashType || m.lineDashType)) &&
                    ((D = p[q].lineColor || C),
                    (s[s.length - 1].newStrokeStyle = D),
                    b.setLineDash &&
                      (p[q].lineDashType
                        ? ((A = p[q].lineDashType),
                          (s[s.length - 1].newLineDashArray = N(A, m.lineThickness)))
                        : ((A = m.lineDashType), (s[s.length - 1].newLineDashArray = E))));
          ...
          if (0 < r.length) {
            ...
            for (; h < r.length; h++)
              if (
                ...
                !(
                  s < a.axisX.dataInfo.viewPortMin ||
                  (s > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !c))
                ))
              ) {
                var Y = u;
                'number' !== typeof r[h].y
                  ...
                  : ((n = a.axisX.convertValueToPixel(s)),
                    ...
                    h < r.length - 1 &&
                      ...
                      f.setLineDash &&
                        (r[h].lineDashType
                          ? ((Q = r[h].lineDashType), f.setLineDash(N(Q, g.lineThickness)))
            ...
            for (var Y = !0, q = 0; q < m.length; q++) {
              ...
              if (
                !(
                  ...
                  (f > a.axisX.dataInfo.viewPortMax && (!A.connectNullData || !Y))
                )
              )
                if ('number' !== typeof fa.y) A.connectNullData || Y || y || d(), (Y = !0);
                  ...
                  y || Y
                    ...
                    : (b.lineTo(g, r),
                      w && s.lineTo(g, r),
                      0 == q % 250 &&
                        (d(), b.moveTo(g, r), w && s.moveTo(g, r), k.push({ x: g, y: n - ma })));
                  u = { x: g, y: r };
                  q < v.length - 1 &&
                    (Q !== (v[q].lineColor || x) || z !== (v[q].lineDashType || A.lineDashType)) &&
                    (d(),
                    b.beginPath(),
                    b.moveTo(g, r),
                    k.push({ x: g, y: n - ma }),
                    ...
                    b.setLineDash &&
                      (v[q].lineDashType
                        ? ((z = v[q].lineDashType), b.setLineDash(N(z, A.lineThickness)))
                  ...
                  0 <= A.dataPointIndexes[f] &&
                    ...
                    ((ma = A.getMarkerProperties(A.dataPointIndexes[f], g, r, b)),
                    l.push(ma),
                    (f = P(F)),
                    w &&
                      l.push({
          ...
          if (0 < m.length) {
            ...
            for (var Y = !0, q = 0; q < m.length; q++) {
              ...
              if (
                ...
                if ('number' !== typeof fa.y) A.connectNullData || Y || s || d(), (Y = !0);
                else {
                  var ma;
                  ...
                  s || Y
                    ? (!s && A.connectNullData
                        ? (b.setLineDash &&
                          ...
                          b.lineTo(g, r),
                          w && z.lineTo(g, r))
                        : (b.beginPath(), b.moveTo(g, r), w && (z.beginPath(), z.moveTo(g, r))),
                      (Y = s = !1))
                    : (b.lineTo(g, r),
                      w && z.lineTo(g, r),
                      0 == q % 250 &&
                        (d(), b.moveTo(g, r), w && z.moveTo(g, r), k.push({ x: g, y: y - ba })));
                  n = { x: g, y: r };
                  q < x.length - 1 &&
                    (Q !== (x[q].lineColor || E) || u !== (x[q].lineDashType || A.lineDashType)) &&
                    (d(),
                    b.beginPath(),
                    b.moveTo(g, r),
                    k.push({ x: g, y: y - ba }),
                    ...
                    b.setLineDash &&
                      (x[q].lineDashType
                        ? ((u = x[q].lineDashType), b.setLineDash(N(u, A.lineThickness)))
                        : ((u = A.lineDashType), b.setLineDash(F))));
                  if (0 <= A.dataPointIndexes[f]) {
                  ...
                  0 <= A.dataPointIndexes[f] &&
                    0 !== fa.markerSize &&
                    (0 < fa.markerSize || 0 < A.markerSize) &&
                    ((ba = A.getMarkerProperties(q, g, r, b)),
                    t.push(ba),
                    (f = P(G)),
                    w &&
                      t.push({
    ...
    n.prototype.renderBubble = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var t = -Infinity, h = Infinity, k = 0; k < a.dataSeriesIndexes.length; k++)
          for (
            var m = a.dataSeriesIndexes[k], p = this.data[m], q = p.dataPoints, g = 0, e = 0;
            e < q.length;
            e++
          )
        ...
        for (
          var r = 25 * Math.PI,
            n = Math.max(Math.pow((0.25 * Math.min(b.height, b.width)) / 2, 2) * Math.PI, r),
            k = 0;
          k < a.dataSeriesIndexes.length;
          k++
        )
              ...
              if (
                ...
                var g = q[e].z,
                  s =
                    2 *
                    Math.max(
                      Math.sqrt((t === h ? n / 2 : r + ((n - r) / (t - h)) * (g - h)) / Math.PI) <<
                        0,
                      1,
                    ),
          ...
          if (0 < m.length) {
            ...
            for (var p = 0, q = 0, e = 0; e < m.length; e++)
              if (
                ...
                c.globalAlpha = 1;
                (Math.sqrt((p - f) * (p - f) + (q - l) * (q - l)) < Math.min(g.size, 5) &&
                  m.length > Math.min(this.plotArea.width, this.plotArea.height)) ||
                  ((p = k.dataPointIds[e]),
    ...
    n.prototype.renderCandlestick = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        this.dataPointMaxWidth &&
          e > f &&
          (e = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, f));
        !this.dataPointMaxWidth &&
          this.dataPointMinWidth &&
          f < e &&
          (f = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, e));
        r < e && (r = e);
        r > f && (r = f);
        c.save();
        w && b.save();
                ...
                'candlestick' === u.type
                  ? (c.moveTo(h - x, m),
                    ...
                    w &&
                      ...
                      b.lineTo(h - x, p),
                      b.stroke(),
                      ea(b, C, Math.min(k, q), D, Math.max(k, q), e, 0, null, !1, !1, !1, !1)))
                  : 'ohlc' === u.type &&
                    (c.moveTo(h - x, m),
                    c.lineTo(h - x, p),
                    c.stroke(),
            ...
            for (var C = 5 < r && y.bevelEnabled ? !0 : !1, l = 0; l < z.length; l++)
              if (
                ...
                var D = (t - r / 2) << 0,
                  ...
                  J = z[l].stemDashType ? z[l].stemDashType : y.stemDashType,
                  H = z[l].lineColor
                    ? z[l].lineColor
                    : z[l].color
                    ? y.lineColor
                ...
                w &&
                  ...
                  0 < ba &&
                    ...
                    b.lineTo(t - E - G, m),
                    b.stroke()),
                  ea(b, D, Math.max(k, m), A, Math.min(k, m), e, 0, null, !1, !1, !1, !1),
                  0 < aa &&
                    (b.beginPath(),
                    (b.lineWidth = aa),
                    b.moveTo(t + Y / 2, p - fa),
    ...
    n.prototype.renderRangeColumn = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        this.dataPointMaxWidth &&
          f > l &&
          (f = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, l));
        !this.dataPointMaxWidth &&
          this.dataPointMinWidth &&
          l < f &&
          (l = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, f));
        k < f && (k = f);
        k > l && (k = l);
        c.save();
        w && this._eventManager.ghostCtx.save();
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var y = 0; y < a.dataSeriesIndexes.length; y++) {
          var z = a.dataSeriesIndexes[y],
            ...
            A = s(C._linkedSeries)
              ? !1
              : C._linkedSeries.type.match(/(bar|column)/gi) && C._linkedSeries.visible
              ? !0
              : !1,
            E = 0;
          if (A)
          ...
          this.dataPointMaxWidth &&
            e > t &&
            (e = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, t));
          !this.dataPointMaxWidth &&
            this.dataPointMinWidth &&
            t < e &&
            (t = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, e));
          u < e && (u = e);
          u > t && (u = t);
          if (0 < D.length)
            for (var F = C._colorSet, t = 0; t < D.length; t++) {
              ...
              if (
                !(r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax) &&
                !s(D[t].y) &&
                D[t].y.length &&
                ...
                b
                  ? ((q = a.axisX.reversed
                      ? (k + ((A ? v : 1) * u) / 2 - (A ? E - 1 : 0) * u) << 0
                      : (k - ((A ? v : 1) * u) / 2 + (A ? E - 1 : 0) * u) << 0),
                    (g = a.axisX.reversed ? (q - u) << 0 : (q + u) << 0))
                  : ((m = a.axisX.reversed
                      ? (h + ((A ? v : 1) * u) / 2 - (A ? E - 1 : 0) * u) << 0
                      : (h - ((A ? v : 1) * u) / 2 + (A ? E - 1 : 0) * u) << 0),
                ...
                x(c, Math.min(m, p), Math.min(q, g), Math.max(p, m), Math.max(g, q), e, Q, aa, b);
          ...
          if (0 < p.length) {
            ...
            for (var Q = !0; g < p.length; g++)
              if (
                ...
                !(
                  u < a.axisX.dataInfo.viewPortMin ||
                  (u > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !Q))
                ))
              )
                if (
                  null !== p[g].y &&
                  ...
                  g < p.length - 1 &&
                    (D !== (p[g].lineColor || v) || A !== (p[g].lineDashType || m.lineDashType)) &&
                    (d(),
                    (D = p[g].lineColor || v),
                    ...
                    b.setLineDash &&
                      (p[g].lineDashType
                        ? ((A = p[g].lineDashType),
                          (h[h.length - 1].newLineDashArray = N(A, m.lineThickness)),
            ...
            for (g = !1; p < m.length; p++)
              if (
                ...
                !(
                  ...
                  (q > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !g))
                ))
              )
                if (
                  null !== m[p].y &&
                  ...
                  x[x.length] = { x: q, y: r };
                  p < m.length - 1 &&
                    (z !== (m[p].lineColor || y) || C !== (m[p].lineDashType || k.lineDashType)) &&
                    ((z = m[p].lineColor || y),
                    (s[s.length - 1].newStrokeStyle = z),
                    b.setLineDash &&
                      (m[p].lineDashType
                        ? ((C = m[p].lineDashType),
                          (s[s.length - 1].newLineDashArray = N(C, k.lineThickness)))
                        : ((C = k.lineDashType), (s[s.length - 1].newLineDashArray = D))));
                  ...
                  0 < p &&
                    ...
                    (k.connectNullData
                      ? b.setLineDash &&
                        0 < s.length &&
                        (k.options.nullDataLineDashType || !m[p - 1].lineDashType) &&
                        ((s[s.length - 1].newLineDashArray = A), (C = k.nullDataLineDashType))
                      : (d(D, y), (s = []), (x = []))),
                    (g = !0);
            d(D, y);
            $.drawMarkers(f);
    ...
    n.prototype.renderWaterfall = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        this.dataPointMaxWidth &&
          l > n &&
          (l = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, n));
        !this.dataPointMaxWidth &&
          this.dataPointMinWidth &&
          n < l &&
          (n = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, l));
        q < l && (q = l);
        q > n && (q = n);
        c.save();
        w && this._eventManager.ghostCtx.save();
        ...
        for (var g = 0; g < a.dataSeriesIndexes.length; g++) {
          ...
          if (0 < v.length)
            for (
              var z = 5 < q && s.bevelEnabled ? !0 : !1, C = !1, x = null, A = null, l = 0;
              l < v.length;
              l++
            )
              if (
                (v[l].getTime ? (m = v[l].x.getTime()) : (m = v[l].x), 'number' !== typeof v[l].y)
              ) {
                ...
                n =
                  0 === s.dataPointEOs[l].cumulativeSum
                    ? p
                    : a.axisY.convertValueToPixel(s.dataPointEOs[l].cumulativeSum);
                k =
                  0 === s.dataPointEOs[l].cumulativeSumYStartValue
                    ? p
                    : a.axisY.convertValueToPixel(s.dataPointEOs[l].cumulativeSumYStartValue);
                h = a.axisX.reversed
                  ? (h +
                ...
                aa =
                  ...
                  ('undefined' !== typeof v[l].isCumulativeSum && !0 === v[l].isCumulativeSum)
                    ? 0 < v[l].y
                      ? n
                      : k
                    : 0 < v[l].y
                ...
                0 < l &&
                  ...
                  0 < u && c.stroke(),
                  w &&
                    (b.beginPath(), b.moveTo(x, A - y), b.lineTo(Q, aa - y), 0 < u && b.stroke()));
                C = !1;
                x = F;
                A = 0 < v[l].y ? n : k;
                Q = v[l].lineDashType
                ...
                (v[l].indexLabel ||
                  ...
                  this._indexLabels.push({
                    ...
                    bounds: { x1: h, y1: Math.min(n, k), x2: F, y2: Math.max(n, k) },
                    color: e,
                  });
              }
        }
    ...
    n.prototype.renderPie = function (a) {
        ...
        if (k && m) {
          for (var a = 0, b = 0, c = 0, d = 0, e = 0; e < m.length; e++) {
            ...
            h.indexLabelMaxWidth = f.indexLabelMaxWidth
              ...
              : 0.33 * q.width;
            h.indexLabelWrap =
              'undefined' !== typeof f.indexLabelWrap ? f.indexLabelWrap : k.indexLabelWrap;
            h.indexLabelTextAlign = f.indexLabelTextAlign
              ...
              : 'left';
            h.startAngle =
              0 === e ? (k.startAngle ? (k.startAngle / 180) * Math.PI : 0) : g[e - 1].endAngle;
          ...
          if (d > c) {
            ...
            if (m[b].exploded) {
              if (
                ...
                (g[b].center.x = z.x + e * a), (g[b].center.y = z.y + f * a), (l = !0);
            } else if (0 < Math.abs(g[b].center.x - z.x) || 0 < Math.abs(g[b].center.y - z.y))
              (g[b].center.x = z.x + e * (1 - a)), (g[b].center.y = z.y + f * (1 - a)), (l = !0);
            l &&
              ((e = {}),
              (e.dataSeries = k),
          ...
          (c = g[b]),
            c.indexLabelText &&
              ...
              'inside' !== c.indexLabelPlacement &&
                ...
                a.setLineDash &&
                  a.setLineDash(N(c.indexLabelLineDashType, c.indexLabelLineThickness)),
                a.beginPath(),
                a.moveTo(d, e),
      ...
      function f(a, c, d) {
        ...
        if (0 <= a && a < m.length) {
          var p = g[a];
          if ((0 > c && p.indexLabelTextBlock.y < k) || (0 < c && p.indexLabelTextBlock.y > h))
            return 0;
          var q = 0,
            t = 0,
            t = (q = q = 0);
          0 > c
            ? p.indexLabelTextBlock.y - p.indexLabelTextBlock.height / 2 > k &&
              p.indexLabelTextBlock.y - p.indexLabelTextBlock.height / 2 + c < k &&
              (c = -(k - (p.indexLabelTextBlock.y - p.indexLabelTextBlock.height / 2 + c)))
            : p.indexLabelTextBlock.y + p.indexLabelTextBlock.height / 2 < k &&
              p.indexLabelTextBlock.y + p.indexLabelTextBlock.height / 2 + c > h &&
              (c = p.indexLabelTextBlock.y + p.indexLabelTextBlock.height / 2 + c - h);
          c = p.indexLabelTextBlock.y + c;
          k = 0;
          k =
            'right' === p.hemisphere
              ? z.x + Math.sqrt(Math.pow(w, 2) - Math.pow(c - z.y, 2))
              : z.x - Math.sqrt(Math.pow(w, 2) - Math.pow(c - z.y, 2));
            ...
            ? ((h = 'right' === p.hemisphere ? t : q),
              ...
              null !== h &&
                ...
                (c =
                  ...
                  (g[h].indexLabelTextBlock.y + g[h].indexLabelTextBlock.height / 2)),
                c - t < r &&
                  ((k = -t),
                  (h = f(h, k, d + 1)),
                  +h.toFixed(y) > +k.toFixed(y) && (l = c > r ? -(c - r) : -(t - (h - k))))))
            : 0 < c &&
              ...
              null !== h &&
                ...
                c - t < r &&
                  ((k = t),
                  (h = f(h, k, d + 1)),
                  +h.toFixed(y) < +k.toFixed(y) && (l = c > r ? c - r : t - (k - h)))));
          l &&
            ((d = p.indexLabelTextBlock.y + l),
            (c = 0),
            (c =
              'right' === p.hemisphere
                ? z.x + Math.sqrt(Math.pow(w, 2) - Math.pow(d - z.y, 2))
                : z.x - Math.sqrt(Math.pow(w, 2) - Math.pow(d - z.y, 2))),
      ...
      function l() {
        ...
        for (var c = (a = 0), d = 0, l = !0, c = 0; 10 > c && (1 > c || 0 < d); c++) {
          ...
          if ('inside' !== k.indexLabelPlacement) {
                ...
                if (0 > C) {
                  for (var x = (s = 0), D = 0; D < m.length; D++)
                    D !== a &&
                      ...
                      (g[D].indexLabelTextBlock.y < h.indexLabelTextBlock.y ? s++ : x++);
                  s = (C / (s + x || 1)) * x;
                  var x = -1 * (C - s),
                    J = (D = 0);
                  'right' === h.hemisphere
            ...
            for (a = 0; a < m.length; a++)
              (h = g[a]),
                (w = 'pie' === k.type ? 0.7 * A : 0.8 * A),
                (u = z.x + w * Math.cos(h.midAngle)),
                (s = z.y + w * Math.sin(h.midAngle)),
          ...
          for (a = 0; a < m.length; a++)
            if (
              ...
              (u = u = 0),
                'right' === h.hemisphere
                  ? ((u = q.x2 - (h.indexLabelTextBlock.x + h.indexLabelTextBlock.width + p)),
                    (u *= -1))
                  : (u = q.x1 - (h.indexLabelTextBlock.x - h.indexLabelTextBlock.width - p)),
                0 < u &&
                  (!l &&
                    h.indexLabelText &&
                    ((s =
                    ...
                    0.3 * h.indexLabelTextBlock.maxWidth < s &&
                      (h.indexLabelTextBlock.x -= 'right' === h.hemisphere ? 2 : -2)),
                  Math.abs(h.indexLabelTextBlock.y - h.indexLabelTextBlock.height / 2 - z.y) < A ||
                    Math.abs(h.indexLabelTextBlock.y + h.indexLabelTextBlock.height / 2 - z.y) <
                      A) &&
                ...
                0 < h.indexLabelAngle && h.indexLabelAngle < Math.PI
                  ? ((u = q.y2 - (h.indexLabelTextBlock.y + h.indexLabelTextBlock.height / 2 + 5)),
                    (u *= -1))
                  : (u = q.y1 - (h.indexLabelTextBlock.y - h.indexLabelTextBlock.height / 2 - 5)),
                0 < u &&
                  (!l &&
                    h.indexLabelText &&
                    ((s = 0 < h.indexLabelAngle && h.indexLabelAngle < Math.PI ? -1 : 1),
                    0 === f(a, u * s) && f(a, 2 * s)),
                  Math.abs(h.indexLabelTextBlock.x - z.x) < A &&
      ...
      function h() {
        ...
        n.legend &&
          (n.legend.dockInsidePlotArea ||
            ('center' === n.legend.horizontalAlign && 'center' === n.legend.verticalAlign)) &&
    ...
    n.prototype.renderFunnel = function (a) {
      ...
      function c() {
        ...
        if (0 === g) return -1;
        for (var l = (d[0] = 0), h = 0, m, p, b = b - a, l = !1, k = 0; k < y.length; k++)
        ...
        if (u && y) {
          ...
          for (var A = 0, D = y.length - 1; A < y.length || 0 <= D; A++, D--) {
            ...
            a = b.color
              ? b.color
              : u.reversed
              ? u._colorSet[(y.length - 1 - A) % u._colorSet.length]
          ...
          for (e = 0; e < O.length; e++)
            0 == I[e].textBlock.text.length
              ...
              : ((a = O[e]),
                ...
                (d = I[e].width),
                b >= c
                  ? ((b = e != ca ? (a.x4 + a.x3) / 2 - d / 2 : (a.x5 + a.x4) / 2 - d / 2),
                    (c = e != ca ? (a.y1 + a.y3) / 2 - c / 2 : (a.y1 + a.y4) / 2 - c / 2),
                    (I[e].textBlock.x = b),
                    (I[e].textBlock.y = c))
                  : (I[e].isDirty = !0));
      }
      ...
      function h(a, b) {
        return (
          ...
          (0 > a ? (u.reversed ? sa - C : na - C) : I[a].textBlock.y + I[a].height + da)
        );
      }
      function n(a, b, c) {
        var d,
        ...
        for (var b, c, d, e, f = 0; f < O.length; f++)
          (e = 1 === I[f].lineThickness % 2 ? 0.5 : 0),
            ...
            I[f].isDirty ||
              ...
              a.setLineDash && a.setLineDash(N(I[f].lineDashType, I[f].lineThickness)),
              a.beginPath(),
              a.moveTo(b, c),
              a.lineTo(d, e),
              a.stroke());
      ...
      function v(a) {
        ...
        x.legend &&
          (x.legend.dockInsidePlotArea ||
            ('center' === x.legend.horizontalAlign && 'center' === x.legend.verticalAlign)) &&
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        for (
          var u = this.data[a.dataSeriesIndexes[0]],
            ...
            A = 0,
            E = z.height - 2 * C,
            F = Math.min(z.width - 2 * D, 2.8 * z.height),
            J = !1,
            H = 0;
          H < y.length;
          H++
        ...
        if (0 != u.length && u.dataPoints && u.visible && 0 !== y.length) {
          ...
          if (-1 !== H) {
            ...
            if (u.reversed)
              for (G = 0; G < H.length; G++)
                F[G] < xa
                  ...
                  : (a.push((F[G] - na + V * W) / V), D.push((F[G] - na + ea * T) / ea));
            else
              for (G = 0; G < H.length; G++)
                F[G] < xa
                  ? (a.push((F[G] - na + V * W) / V), D.push((F[G] - na + ea * T) / ea), (ca = G))
                  : (a.push(L), D.push($));
            ...
            for (G = 0; G < y.length; G++)
              y[G].exploded && ((H = !0), u.reversed ? X.push(y.length - 1 - G) : X.push(G));
            ...
            this.funnelPyramidClickHandler = function (a) {
              ...
              if (
                ...
                if ('funnel' === u.type || 'pyramid' === u.type)
                  u.reversed
                    ? (y[y.length - 1 - a].exploded = y[y.length - 1 - a].exploded ? !1 : !0)
    ...
    n.prototype.replaceKeywordsWithValue = function (a, d, c, b, e) {
      ...
      if (
        ...
        do {
          ...
          a = a.replace(
            '#total',
            da(h, c.yValueFormatString ? c.yValueFormatString : '#,##0.########', f._cultureInfo),
          );
    ...
    F.prototype.setLayout = function () {
      var a = this.dockInsidePlotArea ? this.chart.plotArea : this.chart,
        ...
        l = 0,
        h = (this.markerMargin =
          this.chart.options.legend && !s(this.chart.options.legend.markerMargin)
      ...
      if ('top' === this.verticalAlign || 'bottom' === this.verticalAlign)
        (this.orientation = 'horizontal'),
          ...
          (f = this.maxWidth = null !== this.maxWidth ? this.maxWidth : d.width),
          (l = this.maxHeight = null !== this.maxHeight ? this.maxHeight : 0.5 * d.height);
          ...
          if (
            ...
            var q = (p.legendMarkerType = p.legendMarkerType
              ...
              r = (p.legendMarkerColor = p.legendMarkerColor
                ...
                : p._colorSet[0]),
              w =
                p.markerSize || ('line' !== p.type && 'stepLine' !== p.type && 'spline' !== p.type)
          ...
          if (!(0 >= l || 'undefined' === typeof l || 0 >= v || 'undefined' === typeof v)) {
            ...
            p.width += Math.round(
              q.textBlock.width +
                ...
                h +
                (0 === p.width ? 0 : this.horizontalSpacing) +
                ('line' === q.chartType || 'spline' === q.chartType || 'stepLine' === q.chartType
                  ? 2 * 0.1 * this.lineHeight
                  : 0),
            );
            p.items.push(q);
      ...
      for (var h = 0, n = 0; n < l.length; n++) {
        for (var k = l[n], m = 0, p = 0; p < k.items.length; p++) {
          ...
          $.drawMarker(
            ...
            this.ctx,
            q.markerType,
            'error' === q.chartType || 'line' === q.chartType || 'spline' === q.chartType
              ? q.markerSize / 2
              : q.markerSize,
            q.markerColor,
            q.markerBorderColor,
          ...
          ? ((m = Math.log(this.dataPoints[this.dataPoints.length - 1].x / this.dataPoints[0].x)),
            (m =
              1 < m
                ? Math.min(
                    Math.max(
                      (((this.dataPoints.length - 1) / m) * Math.log(a / this.dataPoints[0].x)) >>
                        0,
                      0,
                    ),
                ...
                : 0))
          : ((m = this.dataPoints[this.dataPoints.length - 1].x - this.dataPoints[0].x),
            (m =
              0 < m
                ? Math.min(
                    Math.max(
                      (((this.dataPoints.length - 1) / m) * (a - this.dataPoints[0].x)) >> 0,
                      0,
                    ),
                    this.dataPoints.length,
                  )
    ...
    H.prototype.getDataPointAtXY = function (a, d, c) {
      ...
      if ('none' !== this.chart.plotInfo.axisPlacement)
        if (
          ((p = (this.chart.axisX[0] ? this.chart.axisX[0] : this.chart.axisX2[0]).getXValueAt({
            x: a,
            y: d,
          })),
          this.axisX.logarithmic)
          ...
          var q = Math.log(this.dataPoints[this.dataPoints.length - 1].x / this.dataPoints[0].x),
            p =
              1 < q
                ? Math.min(
                    Math.max(
                      (((this.dataPoints.length - 1) / q) * Math.log(p / this.dataPoints[0].x)) >>
                        0,
                      0,
                    ),
                    this.dataPoints.length,
          ...
          (q = this.dataPoints[this.dataPoints.length - 1].x - this.dataPoints[0].x),
            (p =
              0 < q
                ? Math.min(
                    Math.max(
                      (((this.dataPoints.length - 1) / q) * (p - this.dataPoints[0].x)) >> 0,
                      0,
                    ),
                    this.dataPoints.length,
                  )
          ...
          if (q) {
            switch (this.type) {
              ...
              case 'scatter':
                ...
                r <= w &&
                  b.push({ dataPoint: g, dataPointIndex: f, dataSeries: this, distance: r });
                q = Math.abs(q.x1 - a);
                q <= n ? (n = q) : 0 < l ? k++ : m++;
                r <= s / 2 && (h = !0);
                break;
              ...
              case 'doughnut':
                ...
                r < q.radius &&
                  ...
                  (s = Number(
                    ((((180 * (q.startAngle / Math.PI)) % 360) + 360) % 360).toFixed(12),
                  )),
                  ...
                  r > s &&
                    r < w &&
                    (b.push({ dataPoint: g, dataPointIndex: f, dataSeries: this, distance: 0 }),
                    (h = !0)));
                break;
              case 'funnel':
              case 'pyramid':
                ...
                d > r.y1 &&
                  ...
                  (r.y6
                    ? d > r.y6
                      ? ((f = r.x6 + ((r.x5 - r.x6) / (r.y5 - r.y6)) * (d - r.y6)),
                        (r = r.x3 + ((r.x4 - r.x3) / (r.y4 - r.y3)) * (d - r.y3)))
                      : ((f = r.x1 + ((r.x6 - r.x1) / (r.y6 - r.y1)) * (d - r.y1)),
                        (r = r.x2 + ((r.x3 - r.x2) / (r.y3 - r.y2)) * (d - r.y2)))
                    : ((f = r.x1 + ((r.x4 - r.x1) / (r.y4 - r.y1)) * (d - r.y1)),
                      (r = r.x2 + ((r.x3 - r.x2) / (r.y3 - r.y2)) * (d - r.y2))),
                  a > f &&
                    a < r &&
                    (b.push({
      ...
      if ('axisX' !== this.type || 'dateTime' !== this.valueType || this.logarithmic) {
        ...
        for (
          this.intervalStartPosition = this.getLabelStartPoint(
            ...
            e = Wa(new Date(this.viewportMaximum), this.interval, this.intervalType),
            g = q,
            c = this.intervalStartPosition;
          c < e;
            ...
            for (
              ...
              if (!this._labels[c].breaksLabelType) {
                ...
                b =
                  ...
                  (l - a.fontSize / 2) * Math.cos((Math.PI / 180) * Math.abs(this.labelAngle));
                if (
                  ...
                  if (
                    ((this.sessionVariables.labelMaxHeight =
                      0 === this.labelAngle
                        ? l
                        : Math.min(
                            (b - f * Math.cos((Math.PI / 180) * Math.abs(this.labelAngle))) /
                              Math.sin((Math.PI / 180) * Math.abs(this.labelAngle)),
                            b,
                          )),
                    (m =
                      (k - (n + a.fontSize / 2) * Math.cos((Math.PI / 180) * Math.abs(-25))) /
                    ...
                    if (s(this.options.labelWrap))
                      if (!s(this.options.labelMaxWidth))
                        ...
                        if (((b = (r.width + d.width) >> 0), (g = this.labelFontSize), q < f))
                            ...
                            b >= 2 * f && b < 2.2 * f
                              ? ((this.sessionVariables.labelMaxWidth = f),
                                s(this.options.labelFontSize) &&
                                  12 < g &&
                                  ((g = Math.floor((12 / 13) * g)), a.measureText()),
                                (this.sessionVariables.labelFontSize = s(this.options.labelFontSize)
                                  ? g
                          ...
                          v === c &&
                          ((0 === v &&
                            q + this._labels[v + 1].textBlock.measureText().width - 2 * f > p) ||
                          ...
                          (p =
                            0 === v
                              ? q + this._labels[v + 1].textBlock.measureText().width - 2 * f
                              : q + this._labels[v - 1].textBlock.measureText().width - 2 * f),
                            (this.sessionVariables.labelFontSize = s(this.options.labelFontSize)
                              ? g
                              : this.options.labelFontSize),
                          ...
                          for (
                            ...
                            (a = this._labels[b].textBlock),
                              (a.maxWidth = this.sessionVariables.labelMaxWidth =
                                Math.min(Math.max(f, q), m)),
                              (r = a.measureText()),
                              b < this._labels.length - 1 &&
                                ((g = b + 1),
                                (d = this._labels[g].textBlock),
                                (d.maxWidth = this.sessionVariables.labelMaxWidth =
                                  Math.min(Math.max(f, q), m)),
                                (d = d.measureText()),
                                (r.width + d.width) >> 0 > 2 * f &&
                                  (this.sessionVariables.labelAngle = -25));
                  ...
                  (this.sessionVariables.labelMaxHeight = this.labelWrap
                    ? (k - m * Math.sin((Math.PI / 180) * Math.abs(this.labelAngle))) /
                      Math.cos((Math.PI / 180) * Math.abs(this.labelAngle))
                    : 1.5 * this.labelFontSize),
                  s(this.options.labelWrap))
                    ? s(this.options.labelWrap) &&
                  ...
                  : ((this.sessionVariables.labelAngle = this.labelAngle),
                    (this.sessionVariables.labelMaxWidth =
                      0 === this.labelAngle
                        ? f
                        : Math.min(
                            (b - l * Math.sin((Math.PI / 180) * Math.abs(this.labelAngle))) /
                              Math.cos((Math.PI / 180) * Math.abs(this.labelAngle)),
                            l,
                          )),
                    s(this.options.labelWrap))
          ...
          if ('bottom' === this._position || 'top' === this._position)
            s(f.options.labelWrap) && !s(this.sessionVariables.stripLineLabelMaxHeight)
              ...
              : (this.sessionVariables.stripLineLabelMaxHeight = x =
                  f.labelWrap ? (0.8 * this.chart.height) >> 0 : 1.5 * this.labelFontSize);
        ...
        if (q[g] && q[g].scaleBreaks && q[g].scaleBreaks._appliedBreaks.length)
          for (
            ...
            r[w].endValue < q[g].viewportMinimum ||
              (s(q[g].scaleBreaks.firstBreakIndex) && (q[g].scaleBreaks.firstBreakIndex = w),
              r[w].startValue >= q[g].viewPortMinimum && (q[g].scaleBreaks.lastBreakIndex = w));
      for (
        var v = (w = 0),
          u = 0,
          y = 0,
      ...
      if ('normal' === e) {
        for (var y = [], z = [], x = [], D = [], M = [], N = [], P = [], R = []; 4 > w; ) {
          var G = 0,
            ...
            $ = 0;
          if (c && 0 < c.length)
            for (x = [], g = O = 0; g < c.length; g++)
              x.push(Math.ceil(c[g] ? c[g].createLabelsAndCalculateWidth() : 0)),
                (O += x[g]),
          ...
          if (b && 0 < b.length)
            for (D = [], g = $ = 0; g < b.length; g++)
              D.push(Math.ceil(b[g] ? b[g].createLabelsAndCalculateWidth() : 0)),
                ($ += D[g]),
                (Z += b[g] ? b[g].margin : 0);
              ...
              a[g] && (a[g].lineCoordinates = {}),
                ...
                a[g].title &&
                  (a[g]._titleTextBlock.maxWidth =
                    0 < a[g].titleMaxWidth && a[g].titleMaxWidth < a[g].lineCoordinates.width
                      ? a[g].titleMaxWidth
                      : a[g].lineCoordinates.width),
                y.push(Math.ceil(a[g] ? a[g].createLabelsAndCalculateHeight() : 0)),
                (T += y[g]),
                (e += a[g] && !m.isNavigator ? a[g].margin : 0);
          else y.push(Math.ceil(a[0] ? a[0].createLabelsAndCalculateHeight() : 0));
          M.push(y);
          if (d && 0 < d.length)
            for (z = [], g = V = 0; g < d.length; g++)
              d[g] && (d[g].lineCoordinates = {}),
                (d[g].lineCoordinates.width = Math.abs(n - l)),
                d[g].title &&
                  (d[g]._titleTextBlock.maxWidth =
                    0 < d[g].titleMaxWidth && d[g].titleMaxWidth < d[g].lineCoordinates.width
                      ? d[g].titleMaxWidth
                      : d[g].lineCoordinates.width),
                z.push(Math.ceil(d[g] ? d[g].createLabelsAndCalculateHeight() : 0)),
                (V += z[g]),
              ...
              a[g] &&
                ...
                !a[g] ||
                  ...
                  0 < a[g].labelAngle
                    ...
                    : 0 > a[g].labelAngle
                    ? A - v < l &&
                      A - v < a[g].viewportMinimum &&
                      (F = l - (L + a[g].tickLength + x + A - v + a[g].labelFontSize / 2))
                    : 0 === a[g].labelAngle &&
                      (E + u > n && (h = E + u / 2 - n - $),
                      A - v < l &&
                        A - v < a[g].viewportMinimum &&
                        (F = l - L - a[g].tickLength - x - A + v / 2)),
                ...
                c[g] &&
                  ...
                  (L =
                    c[g]._labels && 0 < c[g]._labels.length
                      ? c[g]._labels[c[g]._labels.length - 1].textBlock.height / 2
                      : p),
                  ...
                  'inside' === c[g].labelPlacement &&
                    ...
                    ((c[g].lineCoordinates.x1 =
                      c[g].lineCoordinates.x1 -
                      (x[g] - (c[g]._titleTextBlock ? c[g]._titleTextBlock.height : 0)) +
                  ...
                  c[g].title &&
                    (c[g]._titleTextBlock.maxWidth =
                      0 < c[g].titleMaxWidth && c[g].titleMaxWidth < c[g].lineCoordinates.height
                        ? c[g].titleMaxWidth
              ...
              b[g] &&
                ...
                'inside' === b[g].labelPlacement &&
                  ...
                  ((b[g].lineCoordinates.x1 =
                    b[g].lineCoordinates.x1 +
                    (D[g] - (b[g]._titleTextBlock ? b[g]._titleTextBlock.height : 0)) -
                ...
                b[g].title &&
                  (b[g]._titleTextBlock.maxWidth =
                    0 < b[g].titleMaxWidth && b[g].titleMaxWidth < b[g].lineCoordinates.height
                      ? b[g].titleMaxWidth
            ...
            for (g = 0; g < a.length; g++)
              a[g] &&
                ...
                a[g]._labels &&
                  ...
                  ((A =
                    (a[g].logarithmic
                      ? Math.log(a[g]._labels[1].position / a[g].viewportMinimum) /
                  ...
                  (l =
                    a[g]._labels[a[g]._labels.length - ('dateTime' === a[g].valueType ? 2 : 1)]
                      .position),
                  (l = a[g].getApparentDifference(a[g].viewportMinimum, l)),
                  (E = a[g].logarithmic
                    ? (1 < l
                        ? (Math.log(l) / a[g].conversionParameters.lnLogarithmBase) *
                          Math.abs(a[g].conversionParameters.pixelPerUnit)
                        : 0) + a[g].lineCoordinates.x1
                    : (0 < l ? l * Math.abs(a[g].conversionParameters.pixelPerUnit) : 0) +
                      a[g].lineCoordinates.x1)));
          if (d && 0 < d.length)
            for (g = 0; g < d.length; g++)
              d[g].calculateValueToPixelConversionParameters(),
                ...
                d[g]._labels &&
                  ...
                  ((A =
                    (d[g].logarithmic
                      ? Math.log(d[g]._labels[1].position / d[g].viewportMinimum) /
                  ...
                  (l =
                    d[g]._labels[d[g]._labels.length - ('dateTime' === d[g].valueType ? 2 : 1)]
                      .position),
                  (l = d[g].getApparentDifference(d[g].viewportMinimum, l)),
                  (E = d[g].logarithmic
                    ? (1 < l
                        ? (Math.log(l) / d[g].conversionParameters.lnLogarithmBase) *
                          Math.abs(d[g].conversionParameters.pixelPerUnit)
                        : 0) + d[g].lineCoordinates.x1
                    : (0 < l ? l * Math.abs(d[g].conversionParameters.pixelPerUnit) : 0) +
                      d[g].lineCoordinates.x1));
          for (g = 0; g < q.length; g++)
            'axisY' === q[g].type &&
        ...
        for (N = []; 4 > w; ) {
          ...
          if (a && 0 < a.length)
            for (F = [], g = X = 0; g < a.length; g++)
              F.push(Math.ceil(a[g] ? a[g].createLabelsAndCalculateWidth() : 0)),
                (X += F[g]),
                (e += a[g] && !m.isNavigator ? a[g].margin : 0);
          ...
          if (d && 0 < d.length)
            for (v = [], g = T = 0; g < d.length; g++)
              v.push(Math.ceil(d[g] ? d[g].createLabelsAndCalculateWidth() : 0)),
                (T += v[g]),
                (W += d[g] ? d[g].margin : 0);
                  ...
                  (0 < !a.length &&
                    (l =
                      0 > c[g].labelAngle
                        ...
                        : l),
                  0 < !d.length &&
                    (n = 0 < c[g].labelAngle ? n - z / 2 : 0 === c[g].labelAngle ? n - z / 2 : n)),
                (c[g].lineCoordinates.x1 = l),
                (c[g].lineCoordinates.x2 = n),
                (c[g].lineCoordinates.width = Math.abs(n - l)),
                c[g].title &&
                  (c[g]._titleTextBlock.maxWidth =
                    0 < c[g].titleMaxWidth && c[g].titleMaxWidth < c[g].lineCoordinates.width
                      ? c[g].titleMaxWidth
          ...
          if (b && 0 < b.length)
            for (g = 0; g < b.length; g++)
              (b[g].lineCoordinates = {}),
                (l = Math.round(f.x1 + X + e)),
                (n = Math.round(
                  f.x2 - T - W > b[g].chart.width - 10 ? b[g].chart.width - 10 : f.x2 - T - W,
                )),
                b[g] &&
                  b[g].labelAutoFit &&
                  !s(x) &&
                ...
                b[g].title &&
                  (b[g]._titleTextBlock.maxWidth =
                    0 < b[g].titleMaxWidth && b[g].titleMaxWidth < b[g].lineCoordinates.width
                      ? b[g].titleMaxWidth
                      : b[g].lineCoordinates.width);
          if (c && 0 < c.length)
            for (p = [], g = U = 0; g < c.length; g++)
              p.push(Math.ceil(c[g] ? c[g].createLabelsAndCalculateHeight() : 0)),
                (U += p[g] + c[g].margin),
                (L += c[g].margin);
          else p.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateHeight() : 0));
          E.push(p);
          if (b && 0 < b.length)
            for (A = [], g = S = 0; g < b.length; g++)
              A.push(Math.ceil(b[g] ? b[g].createLabelsAndCalculateHeight() : 0)),
                (S += A[g]),
                (Z += b[g].margin);
              ...
              b[g] &&
                ...
                'inside' === b[g].labelPlacement &&
                  ...
                  (b[g].lineCoordinates.y1 =
                    k - A[g] + (b[g]._titleTextBlock ? b[g]._titleTextBlock.height : 0)),
                (b[g].bounds = {
                  x1: l,
                  y1: h + (b[g].margin + G),
                  x2: n,
          ...
          if (a && 0 < a.length)
            for (g = 0; g < a.length; g++) {
                  ...
                  c[L] &&
                    ...
                    ((n =
                      0 > c[L].labelAngle
                        ...
                        ? Math.max(n, y / 2)
                        : n),
                    (l = 0 > c[L].labelAngle || 0 === c[L].labelAngle ? n - X : l));
              if (b && 0 < b.length)
                for (L = 0; L < b.length; L++)
                  b[L] && b[L].labelAutoFit && ((n = b[L].lineCoordinates.x1), (l = n - X));
              a[g].lineCoordinates = {
                x1: n - P,
                y1: h,
                x2: n - P,
              ...
              'inside' === a[g].labelPlacement &&
                ...
                ((a[g].lineCoordinates.x1 =
                  a[g].lineCoordinates.x1 -
                  (F[g] - (a[g]._titleTextBlock ? a[g]._titleTextBlock.height : 0)) +
              ...
              a[g].title &&
                (a[g]._titleTextBlock.maxWidth =
                  0 < a[g].titleMaxWidth && a[g].titleMaxWidth < a[g].lineCoordinates.height
                    ? a[g].titleMaxWidth
          ...
          if (d && 0 < d.length)
            for (g = 0; g < d.length; g++) {
                  ...
                  c[L] &&
                    ...
                    ((n =
                      0 > c[L].labelAngle
                        ...
                        ? Math.max(n, y / 2)
                        : n),
                    (l = 0 > c[L].labelAngle || 0 === c[L].labelAngle ? n - T : l));
              if (b && 0 < b.length)
                for (L = 0; L < b.length; L++)
                  b[L] && b[L].labelAutoFit && ((n = b[L].lineCoordinates.x2), (l = n - T));
              d[g].lineCoordinates = {
                x1: n + R,
                y1: h,
                x2: n + R,
              ...
              'inside' === d[g].labelPlacement &&
                ...
                ((d[g].lineCoordinates.x1 =
                  d[g].lineCoordinates.x1 +
                  (v[g] - (d[g]._titleTextBlock ? d[g]._titleTextBlock.height : 0) - 2) -
              ...
              d[g].title &&
                (d[g]._titleTextBlock.maxWidth =
                  0 < d[g].titleMaxWidth && d[g].titleMaxWidth < d[g].lineCoordinates.height
                    ? d[g].titleMaxWidth
        ...
        if (null !== this.stripLines[a].startValue && null !== this.stripLines[a].endValue) {
          ...
          this.stripLines[a].value = this.logarithmic
            ? this.stripLines[a].value *
              Math.sqrt(
                Math.log(
                  Math.max(this.stripLines[a].startValue, this.stripLines[a].endValue) /
                    Math.min(this.stripLines[a].startValue, this.stripLines[a].endValue),
                ) / Math.log(d),
              )
            : this.stripLines[a].value +
    ...
    E.prototype.calculateBreaksSizeInValues = function () {
      for (
        ...
        (e = b || !s(d[f].options.spacing)),
          (d[f].spacing = Sa(d[f].spacing, a, 8, e ? 0.1 * a : 8, e ? 0 : 3) << 0),
          ...
          if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
            for (
              ...
              p.position > this.viewportMaximum ||
                ...
                (h = p.position),
                (l =
                  p.textBlock.width * Math.abs(Math.cos((Math.PI / 180) * this.labelAngle)) +
                  p.textBlock.height * Math.abs(Math.sin((Math.PI / 180) * this.labelAngle))));
            }
            this._labels = c;
          } else {
          ...
          if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
            for (
              ...
              p.position > this.viewportMaximum ||
                ...
                (h = p.position),
                (m =
                  p.textBlock.height * Math.abs(Math.cos((Math.PI / 180) * this.labelAngle)) +
                      ...
                      'inside' === this.labelPlacement
                        ? 0 > this.labelAngle
                          ...
                          : q.y -
                            ('inside' === this.tickPlacement ? this.tickLength : 0) -
                            Math.abs(
                              p.textBlock.width * Math.sin((Math.PI / 180) * this.labelAngle) + 5,
                            )
                        : q.y +
                          ('inside' === this.tickPlacement ? 0 : this.tickLength) +
                          Math.abs(
          ...
          this.chart.addEventListener(
            ...
            function () {
              for (k = 0; k < a._labels.length; k++)
                if (
                  ((p = a._labels[k]),
                  !(p.position < a.viewportMinimum || p.position > a.viewportMaximum) &&
                    ((q = a.getPixelCoordinatesOnAxis(p.position)), a.tickThickness))
                ) {
                    ...
                    (q.y =
                      'inside' === this.labelPlacement
                        ? 0 < this.labelAngle
                          ? q.y + ('inside' === this.tickPlacement ? this.tickLength : 0) + 5
                          : q.y -
                            p.textBlock.width * Math.sin((Math.PI / 180) * this.labelAngle) +
                            ('inside' === this.tickPlacement ? this.tickLength : 0) +
                            5
                        : q.y -
                          (('inside' === this.tickPlacement ? 0 : this.tickLength) +
    ...
    E.prototype.renderStripLinesOfThicknessType = function (a) {
      if (this.stripLines && 0 < this.stripLines.length && a) {
        for (
          var d = this, c, b = 0, e = 0, f = !1, l = !1, h = [], n = [], l = !1, b = 0;
            ...
            if ('outside' === c.stripLine.labelPlacement)
              if (
                (k &&
                  ...
                  'pixel' === k._thicknessType && (this.ctx.lineWidth = k.thickness)),
                ...
                0 === this.labelAngle
                  ...
                  : ((a.x -=
                    ...
                    (a.y +=
                      ...
                      Math.abs(
                        0 > this.labelAngle
                          ? c.textBlock.width * Math.sin((Math.PI / 180) * this.labelAngle) - 5
                          : 5,
                      )));
              } else
                'top' === this._position
                  ? ((m = 1 === this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0),
                    ...
                    0 === this.labelAngle
                      ? ((a.x -= c.textBlock.width / 2),
                        (a.y -= this.tickLength + c.textBlock.height - c.textBlock.fontSize / 2))
                      : ((a.x +=
                          (c.textBlock.height - this.tickLength - this.labelFontSize / 2) *
                            Math.sin((Math.PI / 180) * this.labelAngle) -
                          (0 < this.labelAngle
                            ? c.textBlock.width * Math.cos((Math.PI / 180) * this.labelAngle)
                            : 0)),
                        (a.y -=
                          this.tickLength +
                          (c.textBlock.height * Math.cos((Math.PI / 180) * this.labelAngle) +
                            (0 < this.labelAngle
                              ? c.textBlock.width * Math.sin((Math.PI / 180) * this.labelAngle)
                              : 0)))))
                  : 'left' === this._position
                      ...
                      : ((a.y -= c.textBlock.width * Math.sin((Math.PI / 180) * this.labelAngle)),
                        (a.x =
                          0 < this.labelAngle
                            ...
                            : a.x -
                              c.textBlock.width * Math.cos((Math.PI / 180) * this.labelAngle) +
                              (c.textBlock.height - c.textBlock.fontSize / 2 - 5) *
                                Math.sin((Math.PI / 180) * this.labelAngle) -
                              this.tickLength)))
              ...
              (c.textBlock.angle = -90),
                'bottom' === this._position
                  ? ((c.textBlock.maxWidth = this.options.stripLines[b].labelMaxWidth
                    ...
                    (a.y =
                      -90 === c.textBlock.angle
                        ? 'near' === c.stripLine.labelAlign
                          ...
                          ? (this.chart.plotArea.y2 + this.chart.plotArea.y1 + c.textBlock.width) /
                            2
        ...
        if (l)
          for (l = !1, b = 0; b < n.length; b++)
            (c = n[b]), 'outside' === c.stripLine.labelPlacement && c.textBlock.render(!0);
      }
    };
    ...
    E.prototype.renderCrosshair = function (a, d) {
      isFinite(this.minimum) &&
        ...
        this.crosshair.dispatchEvent(
          'updated',
          { chart: this.chart, crosshair: this.options, axis: this, value: this.crosshair.value },
          this,
        ));
    };
          ...
          if (this.scaleBreaks && !s(this.scaleBreaks.firstBreakIndex))
            if (s(this.scaleBreaks.lastBreakIndex))
              ...
              for (
                ...
                d.moveTo(e, l),
                  d.lineTo(this.scaleBreaks._appliedBreaks[h].startPixel + c, l),
                ...
                if (e[c].startValue < this.conversionParameters.minimum) {
                  if (
                    ...
                    this.conversionParameters.minimum *
                      Math.pow(e[c].endValue / e[c].startValue, Math.log(b) / Math.log(e[c].size)) <
                      e[c].endValue
                  ) {
                    a = Math.pow(
                    ...
                    (a *=
                      ...
                      Math.pow(
                        e[c].size,
                        Math.log(e[c].endValue / this.conversionParameters.minimum) /
                ...
                if (e[c].endValue > this.conversionParameters.minimum) {
                  if (
                    ...
                    (a *=
                      ...
                      Math.pow(
                        e[c].size,
                        Math.log(e[c].startValue / this.conversionParameters.minimum) /
                          Math.log(e[c].endValue / e[c].startValue),
                      ) *
                      b),
                      (b *= Math.pow(
                        e[c].size,
                        Math.log(this.conversionParameters.minimum / e[c].startValue) /
                          Math.log(e[c].endValue / e[c].startValue),
                      ));
                  d = !1;
                ...
                if (e[c].startValue < this.conversionParameters.minimum) {
                  if (
                    ...
                    (a +=
                      e[c].endValue -
                      this.conversionParameters.minimum -
                      (e[c].size * (e[c].endValue - this.conversionParameters.minimum)) /
                        (e[c].endValue - e[c].startValue)),
                      (b -=
                        (e[c].size * (e[c].endValue - this.conversionParameters.minimum)) /
                        (e[c].endValue - e[c].startValue));
                ...
                if (e[c].endValue > this.conversionParameters.minimum)
                  if (
                    ...
                    (a +=
                      e[c].startValue -
                      this.conversionParameters.minimum +
                      (e[c].size * (this.conversionParameters.minimum - e[c].startValue)) /
                        (e[c].endValue - e[c].startValue)),
                      (b +=
                        (e[c].size * (this.conversionParameters.minimum - e[c].startValue)) /
                        (e[c].endValue - e[c].startValue)),
          ...
          a > e[f].endValue ||
            (a <= e[f].startValue && d >= e[f].endValue
              ...
              ? (c =
                  ...
                  Math.pow(
                    e[f].size,
                    Math.log(e[f].endValue / a) / Math.log(e[f].endValue / e[f].startValue),
                  ))
              : a <= e[f].startValue && d <= e[f].endValue
              ? (c =
                  (c / d) *
                  ...
                  Math.pow(
                    e[f].size,
                    Math.log(d / e[f].startValue) / Math.log(e[f].endValue / e[f].startValue),
                  ))
              : !b &&
                a > e[f].startValue &&
                d < e[f].endValue &&
          ...
          a > e[f].endValue ||
            (a <= e[f].startValue && d >= e[f].endValue
              ...
              ? (c =
                  ...
                  e[f].endValue +
                  a +
                  (e[f].size * (e[f].endValue - a)) / (e[f].endValue - e[f].startValue))
              : a <= e[f].startValue && d < e[f].endValue
              ? (c =
                  c -
                  d +
                  e[f].startValue +
                  (e[f].size * (d - e[f].startValue)) / (e[f].endValue - e[f].startValue))
              : !b &&
                a > e[f].startValue &&
                d < e[f].endValue &&
                (c = a + (e[f].size * (d - a)) / (e[f].endValue - e[f].startValue)));
      return c;
    };
              ...
              ? ((b = b - a[e].endValue + this.viewportMinimum),
                (c =
                  0 < a[e].spacing.toString().indexOf('%')
                    ...
                    : c -
                      (Math.min(a[e].spacing, 0.1 * c) * (a[e].endValue - this.viewportMinimum)) /
                        (a[e].endValue - a[e].startValue)))
              : this.viewportMinimum <= a[e].startValue &&
                this.viewportMaximum < a[e].endValue &&
                ((b = b - this.viewportMaximum + a[e].startValue),
                    ...
                    ? c *
                      (1 -
                        ((parseFloat(a[e].spacing) / 100) *
                          ...
                          (a[e].endValue - a[e].startValue))
                    : c -
                      (Math.min(a[e].spacing, 0.1 * c) * (this.viewportMaximum - a[e].startValue)) /
                        (a[e].endValue - a[e].startValue))));
      ...
      if ('bottom' === this._position || 'top' === this._position)
        this.logarithmic
          ? ((d.lnLogarithmBase = Math.log(this.logarithmBase)),
            (d.pixelPerUnit =
              ((this.reversed ? -1 : 1) * c * d.lnLogarithmBase) / Math.log(Math.abs(b))))
    ...
    E.prototype.calculateAxisParameters = function () {
      if (this.logarithmic) this.calculateLogarithmicAxisParameters();
            ...
            if (
              ((!s(this.sessionVariables.newViewportMinimum) &&
                ...
                (!s(this.options.minimum) &&
                  this.options.minimum >= this.scaleBreaks._appliedBreaks[b].startValue) ||
                (!s(this.options.viewportMinimum) &&
              ...
              ((!s(this.sessionVariables.newViewportMaximum) &&
                ...
                (!s(this.options.maximum) &&
                  this.options.maximum <= this.scaleBreaks._appliedBreaks[b].endValue) ||
                (!s(this.options.viewportMaximum) &&
                  this.viewportMaximum <= this.scaleBreaks._appliedBreaks[b].endValue))
            ) {
        ...
        if ('axisX' === this.type) {
          ...
          0 === f - e &&
            ((b = 'undefined' === typeof this.options.interval ? 0.4 : this.options.interval),
            (f += b),
            (e -= b));
          ...
          'axisY' === this.type &&
            ...
            0 === e && 0 === f
              ...
              : e > f
              ? ((b = Math.min(0.01 * Math.abs(this.getApparentDifference(f, e, null, !0)), 5)),
                0 <= f ? (e = f - b) : (f = isFinite(e) ? e + b : 0))
              : ((b = Math.min(0.01 * Math.abs(this.getApparentDifference(e, f, null, !0)), 0.05)),
                0 !== f && (f += b),
                0 !== e && (e -= b)),
            (h =
              Infinity !== this.dataInfo.minDiff
        ...
        if ('axisX' === this.type && c) {
            ...
            (b / 1 <= a
              ...
              : ((this.interval =
                  b / (1 * R.yearDuration) <= a
                    ...
                    ? 4
                    : Math.floor(E.getNiceNumber(b / (a - 1), !0) / R.yearDuration)),
          ...
          if (null === this.viewportMaximum || isNaN(this.viewportMaximum))
            this.viewportMaximum =
              'axisX' === this.type ? f + h / 2 : Math.ceil(f / this.interval) * this.interval;
    ...
    E.prototype.calculateLogarithmicAxisParameters = function () {
      ...
      h =
        ...
        (isNaN(this.viewportMinimum) || null === this.viewportMinimum ? b : this.viewportMinimum);
      var n =
        (isNaN(this.viewportMaximum) || null === this.viewportMaximum ? e : this.viewportMaximum) -
        (isNaN(this.viewportMinimum) || null === this.viewportMinimum ? b : this.viewportMinimum);
      this.intervalType = 'number';
      ...
      this.options && 0 < this.options.interval
        ...
        : ((this.interval = E.getNiceExponent(Math.log(h) / d / (a - 1), !0)),
          (c = E.getNiceNumber(n / (a - 1), !0)));
      if (null === this.viewportMinimum || isNaN(this.viewportMinimum))
        this.viewportMinimum =
          'axisX' === this.type
            ? b / Math.sqrt(f)
      ...
      1 === this.viewportMaximum &&
        ...
        this.options &&
          'undefined' === typeof this.options.interval &&
          ((this.interval = E.getNiceExponent(Math.ceil(Math.log(h) / d) / (a - 1))),
          (c = E.getNiceNumber((this.viewportMaximum - this.viewportMinimum) / (a - 1), !0))));
      if (null === this.minimum || null === this.maximum)
        'axisX' === this.type
          ...
          : 'axisY' === this.type &&
            ...
            isFinite(b) || isFinite(e)
              ? 1 === b && 1 === e
                ...
                : 1 === e / b
                ? ((h = Math.pow(this.logarithmBase, this.interval)), (e *= h), (b /= h))
                : b > e
                ? ((h = Math.min(0.01 * (b / e), 5)), 1 <= e ? (b = e / h) : (e = b * h))
                : ((h = Math.min(
                    (e / b) * Math.pow(this.logarithmBase, 0.01),
                    Math.pow(this.logarithmBase, 0.04),
                  )),
    ...
    E.generateValueFormatString = function (a, d) {
      var c = '#,##0.',
        b = d;
      1 > a &&
        ((b += Math.floor(Math.abs(Math.log(a) / Math.LN10))), isNaN(b) || !isFinite(b)) &&
        (b = d);
      for (var e = 0; e < b; e++) c += '#';
      return c;
    };
    ...
    M.prototype.createUserOptions = function (a) {
      if ('undefined' !== typeof a || this.options._isPlaceholder) {
        ...
        this.parent.options._isPlaceholder && this.parent.createUserOptions();
        this.options._isPlaceholder ||
          (Da(this.parent.stripLines), (d = this.parent.options.stripLines.indexOf(this.options)));
        this.options = 'undefined' === typeof a ? {} : a;
          ...
          for (var b = 0; b < d.axisY.length; b++)
            this.parent === d.axisY[b] &&
              (d.axisY[b]._crosshairValue =
                a >= d.axisY[b].viewportMinimum && a <= d.axisY[b].viewportMaximum ? a : null);
        else if ('top' === this.parent._position)
          for (b = 0; b < d.axisY2.length; b++)
            this.parent === d.axisY2[b] &&
              (d.axisY2[b]._crosshairValue =
                a >= d.axisY2[b].viewportMinimum && a <= d.axisY2[b].viewportMaximum ? a : null);
    ...
    ca.prototype.render = function (a, d, c) {
      ...
      this.labelFontSize = Math.abs(
        s(this.options.labelFontSize) ? this.parent.labelFontSize : this.labelFontSize,
      );
      ...
      if (this.snapToDataPoint) {
        ...
        if ('xySwapped' === this.chart.plotInfo.axisPlacement) {
          ...
          if ('rangeBar' === m[0].dataSeries.type || 'error' === m[0].dataSeries.type)
            for (
              var v = Math.abs(a - this.parent.convertValueToPixel(m[x].dataPoint.y[0])),
                u = 0,
                r = 0;
              r < m.length;
              r++
              ...
              if (m[r].dataPoint.y && m[r].dataPoint.y.length)
                for (var y = 0; y < m[r].dataPoint.y.length; y++)
                  (u = Math.abs(a - this.parent.convertValueToPixel(m[r].dataPoint.y[y]))),
                    u < v && ((v = u), (x = r));
              else
                (u = Math.abs(a - this.parent.convertValueToPixel(m[r].dataPoint.y))),
                  u < v && ((v = u), (x = r));
          else if ('stackedBar' === m[0].dataSeries.type)
            for (
              var v = Math.abs(a - this.parent.convertValueToPixel(m[0].dataPoint.y)),
                z = (u = 0),
                r = (x = 0);
              r < m.length;
              r++
            ...
            for (
              ...
              if (m[r].dataPoint.y && m[r].dataPoint.y.length)
                ...
                (z += m[r].dataPoint.y),
                  ...
                  (C = 100 * (z / m[r].dataSeries.plotUnit.dataPointYSums[C])),
                  (u = Math.abs(a - this.parent.convertValueToPixel(C))),
                  u < v && ((v = u), (x = r));
          else
            for (
              v = Math.abs(a - this.parent.convertValueToPixel(m[0].dataPoint.y)), r = x = u = 0;
              r < m.length;
              r++
            )
              if (m[r].dataPoint.y && m[r].dataPoint.y.length)
          ...
          if ('bottom' === this.parent._position || 'top' === this.parent._position) {
            ...
            if (
              ...
              for (r = u = 0; r < y.dataPoint.y.length; r++)
                (u = Math.abs(a - this.parent.convertValueToPixel(y.dataPoint.y[r]))),
                  u < v && ((v = u), (b = r));
              n =
                1 === q.lineWidth % 2
              ...
              k.text = this.labelFormatter
                ...
                ? da(c ? c : y.dataPoint.y[b], this.valueFormatString, this.chart._cultureInfo)
                : this.label;
              ...
              k.text = this.labelFormatter
                ...
                : s(this.options.label)
                ? da(c ? c : y.dataPoint.y, this.valueFormatString, this.chart._cultureInfo)
                : this.label;
            ...
            if (C) {
              if ('axisX' === this.parent.type)
                for (
                  r = this.parent.convertPixelToValue({ y: d }), v = null, x = 0;
              ...
              'dateTime' === this.parent.valueType
                ? (k.text = this.labelFormatter
                    ...
                    : s(this.options.label)
                    ? Ba(y.dataPoint.x, this.valueFormatString, this.chart._cultureInfo)
                    : this.label)
                : 'number' === this.parent.valueType &&
                  (k.text = this.labelFormatter
                    ...
                    : s(this.options.label)
                    ? da(y.dataPoint.x, this.valueFormatString, this.chart._cultureInfo)
                    : this.label);
          ...
          if (
            ...
            for (
              v = Math.abs(d - this.parent.convertValueToPixel(m[0].dataPoint.y[0])), r = u = 0;
              r < m.length;
              r++
            )
              if (m[r].dataPoint.y && m[r].dataPoint.y.length)
                for (y = 0; y < m[r].dataPoint.y.length; y++)
                  (u = Math.abs(d - this.parent.convertValueToPixel(m[r].dataPoint.y[y]))),
                    u < v && ((v = u), (x = r));
              else
                (u = Math.abs(d - this.parent.convertValueToPixel(m[r].dataPoint.y))),
                  u < v && ((v = u), (x = r));
          else if (
            ...
            for (
              v = Math.abs(d - this.parent.convertValueToPixel(m[0].dataPoint.y)), r = z = u = 0;
              r < m.length;
              r++
            )
              if (m[r].dataPoint.y && m[r].dataPoint.y.length)
            ...
            for (
              v = Math.abs(d - this.parent.convertValueToPixel(m[0].dataPoint.y)), r = u = 0;
              r < m.length;
              r++
            )
              if (m[r].dataPoint.y && m[r].dataPoint.y.length)
          ...
          if (
            ...
            for (r = u = 0; r < y.dataPoint.y.length; r++)
              (u = Math.abs(d - this.parent.convertValueToPixel(y.dataPoint.y[r]))),
                u < v && ((v = u), (b = r));
            w =
              1 === q.lineWidth % 2
                ? (this.parent.convertValueToPixel(y.dataPoint.y[b]) << 0) + 0.5
            ...
            'waterfall' === this.parent.dataSeries[x].type
              ...
              : ((w =
                  1 === q.lineWidth % 2
                    ? (s(a) ? d : this.parent.convertValueToPixel(y.dataPoint.y) << 0) + 0.5
                    : s(a)
                    ? d
                    : this.parent.convertValueToPixel(y.dataPoint.y) << 0),
                (k.text = this.labelFormatter
        ...
        if ('bottom' === this.parent._position || 'top' === this.parent._position)
          'top' === this.parent._position &&
            ...
            'bottom' === this.parent._position &&
              this.parent.lineCoordinates.y2 - k.fontSize / 2 + k.measureText().height >
                this.chart.bounds.y2 &&
              (k.y = this.chart.bounds.y2 - k.height + k.fontSize / 2 + 2),
            b >=
              this.parent.convertValueToPixel(
                this.parent.reversed ? this.parent.viewportMaximum : this.parent.viewportMinimum,
              ) &&
              e <=
                this.parent.convertValueToPixel(
                  this.parent.reversed ? this.parent.viewportMinimum : this.parent.viewportMaximum,
                ) &&
    ...
    ca.prototype.renderLabel = function () {
      s(this._textBlock) ||
        ...
        !('number' === typeof this._textBlock.text.valueOf() || 0 < this._textBlock.text.length) ||
        this._hidden ||
    ...
    W.prototype._updateToolTip = function (a, d, c) {
      ...
      if (!this.chart.disableToolTip) {
        ...
        if (this.shared && this.enabled && 'none' !== this.chart.plotInfo.axisPlacement) {
          if ('xySwapped' === this.chart.plotInfo.axisPlacement) {
            ...
            if (this.chart.axisX)
              for (var v = 0; v < this.chart.axisX.length; v++) {
                for (
                  var h = this.chart.axisX[v].convertPixelToValue({ y: d }), k = null, b = 0;
            ...
            if (this.chart.axisX2)
              for (v = 0; v < this.chart.axisX2.length; v++) {
                ...
                for (b = 0; b < this.chart.axisX2[v].dataSeries.length; b++)
                  (k = this.chart.axisX2[v].dataSeries[b].getDataPointAtX(h, c)) &&
                    0 <= k.index &&
            ...
            if (this.chart.axisX)
              for (v = 0; v < this.chart.axisX.length; v++)
                for (
                  h = this.chart.axisX[v].convertPixelToValue({ x: a }), k = null, b = 0;
                  b < this.chart.axisX[v].dataSeries.length;
                  b++
                )
                  (k = this.chart.axisX[v].dataSeries[b].getDataPointAtX(h, c)) &&
            ...
            if (this.chart.axisX2)
              for (v = 0; v < this.chart.axisX2.length; v++)
                for (
                  h = this.chart.axisX2[v].convertPixelToValue({ x: a }), k = null, b = 0;
          ...
          c = n[0];
          for (b = 0; b < n.length; b++)
            n[b].dataPoint.x.valueOf() === c.dataPoint.x.valueOf() && f.push(n[b]);
          n = null;
        } else {
            ...
            if (0 <= this.currentDataPointIndex)
              (b = e.dataPoints[this.currentDataPointIndex]),
                ...
                'waterfall' === e.type &&
                  ...
                  (k.cumulativeSum = e.dataPointEOs[this.currentDataPointIndex].cumulativeSum));
            else {
              if (
                !this.enabled ||
                ('line' !== e.type &&
              ...
              s(k) ||
                ((k.dataSeries = e), (this.currentDataPointIndex = k.index), (b = k.dataPoint));
            }
                ...
                if (0 < k.dataPoint.y.length) {
                  for (b = c = 0; b < k.dataPoint.y.length; b++)
                    k.dataPoint.y[b] < k.dataSeries.axisY.viewportMinimum
                      ? c--
                      : k.dataPoint.y[b] > k.dataSeries.axisY.viewportMaximum && c++;
                  ...
                  'column' === e.type || 'bar' === e.type
                    ...
                    ? ((c = this.chart._eventManager.objectMap[e.dataPointIds[k.index]].size / 2),
                      k.dataPoint.y >= k.dataSeries.axisY.viewportMinimum - c &&
                        k.dataPoint.y <= k.dataSeries.axisY.viewportMaximum + c &&
                        f.push(k))
                    : 'waterfall' === e.type
                    ? ((c = 0),
                      k.cumulativeSumYStartValue < k.dataSeries.axisY.viewportMinimum
                        ? c--
                        : k.cumulativeSumYStartValue > k.dataSeries.axisY.viewportMaximum && c++,
                      k.cumulativeSum < k.dataSeries.axisY.viewportMinimum
                        ? c--
                        : k.cumulativeSum > k.dataSeries.axisY.viewportMaximum && c++,
                      2 > c && -2 < c && f.push(k))
                    : (0 <= k.dataSeries.type.indexOf('100') ||
                        'stackedColumn' === e.type ||
                        'stackedBar' === e.type ||
                        (k.dataPoint.y >= k.dataSeries.axisY.viewportMinimum &&
                          k.dataPoint.y <= k.dataSeries.axisY.viewportMaximum)) &&
                      f.push(k);
              else f.push(k);
          }
        }
          ...
          if ((this.highlightObjects(f), this.enabled)) {
            ...
            if (null !== c) {
              ...
              if (
                ...
                for (
                  h = this.contentDiv.getElementsByTagName('span'),
                    b = 0,
                    v = this.reversed ? f.length - 1 : 0;
                  b < f.length, this.reversed ? 0 <= v : v < f.length;
                  b++, this.reversed ? v-- : v++
                )
                  h[b] &&
                    (h[b].style.color = this.chart.replaceKeywordsWithValue(
                      '{color}',
                      f[v].dataPoint,
                      f[v].dataSeries,
                      f[v].index,
              ...
              this.hide(!1),
                this.enabled &&
                  this.dispatchEvent('hidden', { chart: this.chart, toolTip: this }, this);
            d = [];
            for (b = 0; b < f.length; b++)
              d.push({
    ...
    W.prototype.getToolTipInnerHTML = function (a) {
      ...
      if (
        this.isToolTipDefinedInData &&
        ((this.content && 'function' === typeof this.content) || this.contentFormatter)
      )
      ...
      if (0 < f.length) {
        ...
        if (null !== h) {
          ...
          if (
            ...
            for (
              b = this.contentDiv.getElementsByTagName('span'),
                h = 0,
                e = this.reversed ? f.length - 1 : 0;
              h < f.length, this.reversed ? 0 <= e : e < f.length;
              h++, this.reversed ? e-- : e++
            )
              b[h] &&
                (b[h].style.color = this.chart.replaceKeywordsWithValue(
                  '{color}',
                  f[e].dataPoint,
                  f[e].dataSeries,
                  f[e].index,
    ...
    ga.prototype.fireEvent = function (a, d, c) {
      if (a && d) {
        ...
        'click' === d &&
          ...
          this.chart.pieDoughnutClickHandler.call(this.chart.data[a.dataSeriesIndex], b);
        'click' === d &&
          'dataPoint' === a.objectType &&
    ...
    var K = {
        ...
        xClipAnimation: function (a, d) {
          if (0 !== a) {
            ...
            c.save();
            0 < a &&
              c.drawImage(b, 0, 0, b.width * a, b.height, 0, 0, (b.width * a) / ka, b.height / ka);
            c.restore();
          }
        },
